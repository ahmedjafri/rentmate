...
from llm.dispatch import dispatch, get_tool, tool_definitions
from llm.loop import AgentLoop, TenantIsolationError
...
def test_dispatch_simulation_gate_blackholes_read_write():
    from llm.tools._common import simulation_suggestions
