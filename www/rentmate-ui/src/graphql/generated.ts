...
export type AddLeaseForTenantInput = {
  ...
  tenantIds: Array<Scalars['String']['input']>;
...
export type ChatMessageType = {
  ...
  reviewCard: Maybe<ChatReviewCardType>;
...
export type ChatReviewCardType = {
...
export type ConversationSummaryType = {
  ...
  headerDescription: Maybe<Scalars['String']['output']>;
  ...
  mirrorSource: Maybe<Scalars['String']['output']>;
  participantCount: Scalars['Int']['output'];
  participantLabel: Maybe<Scalars['String']['output']>;
...
export type ConversationTurnInput = {
  isPm: InputMaybe<Scalars['Boolean']['input']>;
...
export type CreateTenantWithLeaseInput = {
  additionalTenants: Array<NewTenantForLeaseInput>;
  email: InputMaybe<Scalars['String']['input']>;
  existingTenantIds: Array<Scalars['String']['input']>;
...
export type Mutation = {
  ...
  markConversationSeen: ConversationSummaryType;
  /** Mark a task as seen in the tasks view */
  markTaskSeen: TaskType;
...
export type MutationMarkTaskSeenArgs = {
  uid: Scalars['Int']['input'];
};
...
export type NewTenantForLeaseInput = {
  email: InputMaybe<Scalars['String']['input']>;
  firstName: Scalars['String']['input'];
  lastName: Scalars['String']['input'];
  phone: InputMaybe<Scalars['String']['input']>;
...
export type Query = {
  ...
  conversation: Maybe<ConversationSummaryType>;
...
export type SuggestionType = {
  ...
  targetConversationId: Maybe<Scalars['String']['output']>;
  targetConversationType: Maybe<Scalars['String']['output']>;
  taskId: Maybe<Scalars['String']['output']>;
  title: Maybe<Scalars['String']['output']>;
  uid: Scalars['Int']['output'];
  unitId: Maybe<Scalars['String']['output']>;
...
export type TaskQuery = { task: { uid: number, taskNumber: number | null, title: string | null, taskStatus: TaskStatus | null, taskMode: TaskMode | null, source: TaskSource | null, category: TaskCategory | null, urgency: Urgency | null, priority: TaskPriority | null, confidential: boolean, lastMessageAt: string | null, propertyId: string | null, unitId: string | null, createdAt: string, tenantName: string | null, unitLabel: string | null, aiTriageSuggestion: string | null, vendorAssigned: string | null, requireVendorType: string | null, assignedVendorId: string | null, assignedVendorName: string | null, aiConversationId: string | null, parentConversationId: string | null, externalConversationIds: Array<string>, steps: unknown | null, goal: string | null, suggestionOptions: unknown | null, lastReviewedAt: string | null, lastReviewStatus: string | null, lastReviewSummary: string | null, lastReviewNextStep: string | null, unreadCount: number, linkedConversations: Array<{ uid: string, label: string, conversationType: ConversationType, lastMessageAt: string | null, messageCount: number, unreadCount: number, participants: Array<{ name: string, participantType: string, entityId: string | null, portalUrl: string | null }> }>, messages: Array<{ uid: string, body: string | null, messageType: MessageType | null, senderName: string | null, senderType: string | null, isAi: boolean, isSystem: boolean, draftReply: string | null, approvalStatus: string | null, relatedTaskIds: unknown | null, suggestionId: string | null, sentAt: string, actionCard: { kind: string, title: string, summary: string | null, fields: Array<{ label: string, value: string }>, links: Array<{ label: string, entityType: string, entityId: string, propertyId: string | null }>, units: Array<{ uid: string, label: string, propertyId: string }> } | null, reviewCard: { status: string, summary: string | null, nextStep: string | null } | null }> } | null };
...
export type GetConversationQuery = { conversation: { uid: string, conversationType: ConversationType, title: string | null, taskId: string | null, taskTitle: string | null, participantLabel: string | null, mirrorSource: string | null, headerDescription: string | null } | null };
...
export type GetConversationsQuery = { conversations: Array<{ uid: string, conversationType: ConversationType, title: string | null, lastMessageAt: string | null, updatedAt: string, lastMessageBody: string | null, lastMessageSenderName: string | null, propertyName: string | null, participantCount: number, unreadCount: number, participantLabel: string | null, taskId: string | null, taskTitle: string | null }> };
...
export type MarkTaskSeenMutationVariables = Exact<{
  uid: Scalars['Int']['input'];
}>;


export type MarkTaskSeenMutation = { markTaskSeen: { uid: number, unreadCount: number } };
...
export type MarkConversationSeenMutation = { markConversationSeen: { uid: string, unreadCount: number } };
...
export type SendMessageMutation = { sendMessage: { uid: string, body: string | null, messageType: MessageType | null, senderName: string | null, senderType: string | null, isAi: boolean, isSystem: boolean, draftReply: string | null, approvalStatus: string | null, suggestionId: string | null, sentAt: string, actionCard: { kind: string, title: string, summary: string | null, fields: Array<{ label: string, value: string }>, links: Array<{ label: string, entityType: string, entityId: string, propertyId: string | null }>, units: Array<{ uid: string, label: string, propertyId: string }> } | null, reviewCard: { status: string, summary: string | null, nextStep: string | null } | null } };
...
export const MarkTaskSeenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MarkTaskSeen"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"markTaskSeen"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"unreadCount"}}]}}]}}]} as unknown as DocumentNode<MarkTaskSeenMutation, MarkTaskSeenMutationVariables>;
export const MarkConversationSeenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MarkConversationSeen"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"markConversationSeen"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"uid"}},{"kind":"Field","name":{"kind":"Name","value":"unreadCount"}}]}}]}}]} as unknown as DocumentNode<MarkConversationSeenMutation, MarkConversationSeenMutationVariables>;
