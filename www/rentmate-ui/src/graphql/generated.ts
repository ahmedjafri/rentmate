...
export type GetConversationQuery = { conversation: { uid: string, conversationType: ConversationType, title: string | null, taskId: string | null, taskTitle: string | null, participantLabel: string | null } | null };
