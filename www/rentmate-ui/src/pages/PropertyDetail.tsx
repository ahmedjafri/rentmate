  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <EntityContextCard entityId={property.id} entityName={property.name || property.address} entityType="property" agentContext={property.context} expectedTopics={propertyTopics} autoContext={autoContext} />
        <Card className="p-4 rounded-xl">
